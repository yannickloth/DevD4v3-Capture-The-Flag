...
/// <remarks>Change drivers: CD-02 (CTF game-rules specification); CD-29 (code-under-test: Team.HandleFlagInteraction); CD-26 (NUnit test-framework contract) → CD-29; CD-27 (FluentAssertions contract) → CD-29</remarks>
