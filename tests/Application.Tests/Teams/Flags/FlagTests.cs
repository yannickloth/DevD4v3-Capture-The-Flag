...
/// <remarks>Change drivers: CD-02 (CTF game-rules specification), CD-29 (code-under-test: Flag), CD-26 (NUnit test-framework contract), CD-27 (FluentAssertions contract)</remarks>
