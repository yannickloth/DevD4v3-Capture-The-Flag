...
/// <remarks>Change drivers: CD-26 (NUnit test-framework contract), CD-27 (FluentAssertions contract), CD-29 (code-under-test: health/armour extensions), CD-03 (combat/weapon-rules specification)</remarks>
