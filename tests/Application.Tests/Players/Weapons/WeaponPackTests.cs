...
/// <remarks>Change drivers: CD-03 (combat/weapon-rules specification), CD-29 (code-under-test: WeaponPack), CD-26 (NUnit test-framework contract), CD-27 (FluentAssertions contract)</remarks>
