...
/// <remarks>Change drivers: CD-04 (weapon-catalog configuration), CD-29 (code-under-test: WeaponCatalogType), CD-26 (NUnit test-framework contract), CD-27 (FluentAssertions contract)</remarks>
