...
/// <remarks>Change drivers: CD-04 (weapon-catalog configuration), CD-17 (game configuration/.env schema), CD-29 (code-under-test: WeaponCatalogSettings), CD-26 (NUnit test-framework contract), CD-27 (FluentAssertions contract)</remarks>
