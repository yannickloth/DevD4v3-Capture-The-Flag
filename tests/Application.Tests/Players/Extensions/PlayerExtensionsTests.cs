...
/// <remarks>Change drivers: CD-08 (account & authentication policy), CD-01 (open.mp/SampSharp platform API), CD-29 (code-under-test: PlayerExtensions), CD-26 (NUnit test-framework contract), CD-27 (FluentAssertions contract)</remarks>
