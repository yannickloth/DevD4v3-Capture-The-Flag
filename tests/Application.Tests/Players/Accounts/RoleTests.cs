...
/// <remarks>Change drivers: CD-09 (authorization policy); CD-29 (code-under-test: PlayerInfo.SetRole/HasRole); CD-26 (NUnit test-framework contract) → CD-29; CD-27 (FluentAssertions contract) → CD-29</remarks>
