...
/// <remarks>Change drivers: CD-29 (root; code-under-test: PlayerInfo.SetRole/HasRole); CD-26 (NUnit test-framework contract) → CD-29; CD-27 (FluentAssertions contract) → CD-29; CD-09 (authorization policy) → CD-29</remarks>
