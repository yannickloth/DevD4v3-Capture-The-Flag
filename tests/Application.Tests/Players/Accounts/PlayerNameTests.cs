...
/// <remarks>Change drivers: CD-08 (account & authentication policy), CD-29 (code-under-test: PlayerInfo.SetName), CD-26 (NUnit test-framework contract), CD-27 (FluentAssertions contract)</remarks>
