...
/// <remarks>Change drivers: CD-29 (root; code-under-test: PlayerInfo.SetName); CD-26 (NUnit test-framework contract) → CD-29; CD-27 (FluentAssertions contract) → CD-29; CD-08 (account & authentication policy) → CD-29</remarks>
