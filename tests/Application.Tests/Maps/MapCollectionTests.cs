...
/// <remarks>Change drivers: CD-11 (map configuration); CD-29 (code-under-test: MapCollection); CD-26 (NUnit test-framework contract) → CD-29; CD-27 (FluentAssertions contract) → CD-29</remarks>
