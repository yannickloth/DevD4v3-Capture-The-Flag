...
/// <remarks>Change drivers: CD-12 (map-rotation rules); CD-29 (code-under-test: LoadTime); CD-26 (NUnit test-framework contract) → CD-29; CD-27 (FluentAssertions contract) → CD-29</remarks>
