...
/// <remarks>Change drivers: CD-26 (NUnit test-framework contract), CD-27 (FluentAssertions contract), CD-29 (code-under-test: IPlayerRepository.Exists), CD-20 (outbound repository contract), CD-18 (database schema/player data model).</remarks>
public class PlayerExists
{
    /// <remarks>Change drivers: CD-26 (NUnit test-framework contract), CD-27 (FluentAssertions contract), CD-29 (code-under-test: IPlayerRepository.Exists), CD-20 (outbound repository contract).</remarks>
