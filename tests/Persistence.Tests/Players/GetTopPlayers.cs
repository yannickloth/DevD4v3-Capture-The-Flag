...
/// <remarks>Change drivers: CD-20 (outbound repository contract), CD-18 (database schema/player data model), CD-29 (code-under-test: ITopPlayersRepository.GetByTotalKills/GetByMaxKillingSpree), CD-26 (NUnit test-framework contract), CD-27 (FluentAssertions contract)</remarks>
public class GetTopPlayers
{
    /// <remarks>Change drivers: CD-20 (outbound repository contract), CD-29 (code-under-test: ITopPlayersRepository.GetByTotalKills), CD-26 (NUnit test-framework contract), CD-27 (FluentAssertions contract)</remarks>
    ...
    /// <remarks>Change drivers: CD-20 (outbound repository contract), CD-29 (code-under-test: ITopPlayersRepository.GetByMaxKillingSpree), CD-26 (NUnit test-framework contract), CD-27 (FluentAssertions contract)</remarks>
    [TestCaseSource(typeof(RepositoryManagerTestCases))]
