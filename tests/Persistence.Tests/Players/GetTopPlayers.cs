...
/// <remarks>Change drivers: CD-20 (root; outbound repository contract: ITopPlayersRepository.GetByTotalKills/GetByMaxKillingSpree); CD-26 (NUnit test-framework contract) → CD-20; CD-27 (FluentAssertions contract) → CD-20; CD-18 (database schema/player data model) → CD-20</remarks>
public class GetTopPlayers
{
    /// <remarks>Change drivers: CD-20 (root; outbound repository contract: ITopPlayersRepository.GetByTotalKills); CD-26 (NUnit test-framework contract) → CD-20; CD-27 (FluentAssertions contract) → CD-20</remarks>
    ...
    /// <remarks>Change drivers: CD-20 (root; outbound repository contract: ITopPlayersRepository.GetByMaxKillingSpree); CD-26 (NUnit test-framework contract) → CD-20; CD-27 (FluentAssertions contract) → CD-20</remarks>
    [TestCaseSource(typeof(RepositoryManagerTestCases))]
