...
/// <remarks>Change drivers: CD-20 (outbound repository contract), CD-19 (MariaDB SQL dialect), CD-30 (SQLite SQL dialect), CD-29 (code-under-test: exposes the repository seams under test)</remarks>
