...
/// <remarks>Change drivers: CD-29 (root; code-under-test: mimics the <c>IPasswordHasher</c> seam); CD-25 (BCrypt password-hashing contract it must satisfy) → CD-29</remarks>
public class FakePasswordHasher : IPasswordHasher
{
    /// <summary>Returns the input unchanged.</summary>
    /// <remarks>Change drivers: CD-29 (root; code-under-test: IPasswordHasher contract); CD-25 (BCrypt password-hashing contract) → CD-29</remarks>
