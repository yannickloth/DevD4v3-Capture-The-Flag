...
/// <remarks>Change drivers: CD-25 (BCrypt password-hashing contract); CD-20 (outbound repository contract); CD-18 (database schema/player data model); CD-19 (MariaDB SQL dialect) → CD-18; CD-21 (DI container/composition); CD-29 (code-under-test: the MariaDB repository seam)</remarks>
public class MariaDbRepositoryManager : IRepositoryManager
{
    ...
    /// <remarks>Change drivers: CD-18 (database schema/player data model); CD-19 (MariaDB SQL dialect) → CD-18</remarks>
