...
/// <remarks>Change drivers: CD-20 (outbound repository contract), CD-19 (MariaDB SQL dialect), CD-30 (SQLite SQL dialect), CD-21 (DI container/composition), CD-29 (code-under-test: the repository seam per provider)</remarks>
public class RepositoryManagerFactory
{
    /// <summary>Creates the repository manager for a provider.</summary>
    /// <remarks>Change drivers: CD-20 (outbound repository contract), CD-19 (MariaDB SQL dialect), CD-30 (SQLite SQL dialect), CD-21 (DI container/composition)</remarks>
