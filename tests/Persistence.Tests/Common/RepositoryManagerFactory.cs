...
/// <remarks>Change drivers: CD-29 (root; code-under-test: the repository seam per provider); CD-19 (MariaDB SQL dialect) → CD-29; CD-30 (SQLite SQL dialect) → CD-29; CD-20 (outbound repository contract) → CD-29; CD-21 (DI container/composition) → CD-29</remarks>
