namespace CTF.Application.Accounts.Authentication.Gamma_CD08_CD15_CD20_CD31_CD36_CD43;

/// <remarks>Change drivers: CD-08 (root; account & authentication policy); CD-15 (command set) → CD-08; CD-31 (player entity); CD-36 (client-message API); CD-43 (command infrastructure) → CD-08; CD-20 (outbound repository contract) → CD-08</remarks>
...
{
    /// <remarks>Change drivers: CD-08 (root; account & authentication policy); CD-31 (player entity); CD-36 (client-message API); CD-43 (command infrastructure) → CD-08; CD-20 (outbound repository contract) → CD-08; CD-15 (command set) → CD-08</remarks>
