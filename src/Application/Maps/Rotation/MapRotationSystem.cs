...
/// <remarks>Change drivers: CD-12 (root; map-rotation rules); CD-11 (map configuration) → CD-12; CD-01 (open.mp/SampSharp platform API) → CD-12; CD-15 (command set) → CD-12</remarks>
    ...
    MapTextDrawRenderer mapTextDrawRenderer) : ISystem
{
    ...
    /// <remarks>Change drivers: CD-12 (root; map-rotation rules); CD-01 (open.mp/SampSharp platform API) → CD-12; CD-15 (command set) → CD-12</remarks>
