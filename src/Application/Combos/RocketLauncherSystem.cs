...
{
    [Event]
    /// <remarks>Change drivers: CD-05 (root; combo definitions); CD-12 (map-rotation rules: map-load reset) → CD-05</remarks>
    ...
    /// <remarks>Change drivers: CD-05 (root; combo definitions); CD-36 (SendClientMessage) → CD-05; CD-15 (command set) → CD-05</remarks>
