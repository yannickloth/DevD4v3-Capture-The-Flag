...
/// <remarks>Change drivers: CD-05 (root; combo definitions); CD-15 (command set) → CD-05; CD-09 (authorization policy) → CD-05; CD-12 (map-rotation rules) → CD-05; CD-01 (open.mp/SampSharp platform API) → CD-05</remarks>
/// <remarks>Injected dependencies (change drivers of these elements): worldService -> CD-01; comboSettings -> CD-05. Each injection parameter is driven by the contract of its injected type + CD-21 (DI wiring).</remarks>
    ...
    ComboSettings comboSettings) : ISystem
{
    ...
    /// <remarks>Change drivers: CD-05 (root; combo definitions); CD-01 (open.mp/SampSharp platform API) → CD-05; CD-15 (command set) → CD-05</remarks>
