...
/// </summary>
/// <remarks>Change drivers: CD-13 (root; chat rules); CD-31 (player events); CD-32 (ECS runtime); CD-36 (client messages) → CD-13</remarks>
...
public class ChatSystem(FrozenDictionary<char, IChatMessage> chats) : ISystem
{
    ...
    /// <remarks>Change drivers: CD-13 (root; chat rules); CD-31 (OnPlayerText); CD-36 (client messages) → CD-13</remarks>
    /// <remarks>
