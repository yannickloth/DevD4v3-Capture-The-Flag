...
public class TeamSounds
{
    ...
    /// <remarks>Change drivers: CD-17 (root; root; game configuration/.env schema: audio URLs)</remarks>
    ...
    /// </summary>
    /// <remarks>Change drivers: CD-01 (root; root; open.mp/SampSharp platform API: audio)</remarks>
