...
/// </summary>
/// <remarks>Change drivers: CD-01 (open.mp/SampSharp platform API: map-icon ids).</remarks>
public enum FlagIcon
{
    /// <summary>The white flag icon.</summary>
    /// <remarks>Change drivers: CD-01 (open.mp/SampSharp platform API: map-icon id).</remarks>
    White = 1,
