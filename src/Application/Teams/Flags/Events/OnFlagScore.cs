...
/// </summary>
/// <remarks>Change drivers: CD-10 (player-statistics/rank model: brought flags), CD-02 (CTF game-rules specification: flag score rule), CD-06 (coin economy: coins-on-flag-event), CD-20 (outbound repository contract: UpdateBroughtFlags), CD-01 (open.mp/SampSharp platform API: pickups, audio, GameText, textdraw)</remarks>
    ...
    PlayerStatsRenderer playerStatsRenderer) : IFlagEvent
{
    ...
    /// <remarks>Change drivers: CD-10 (player-statistics/rank model: brought flags), CD-02 (CTF game-rules specification: flag score rule), CD-06 (coin economy: coins-on-flag-event), CD-20 (outbound repository contract: UpdateBroughtFlags)</remarks>
