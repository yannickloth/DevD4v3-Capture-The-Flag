...
/// </summary>
/// <remarks>Change drivers: CD-02 (CTF game-rules specification: flag take rule), CD-17 (game configuration/.env schema: FlagCarrier__ShowOnRadarMap), CD-01 (open.mp/SampSharp platform API: pickups, radar, audio, GameText)</remarks>
