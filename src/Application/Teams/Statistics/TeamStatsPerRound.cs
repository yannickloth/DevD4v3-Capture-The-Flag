...
public class TeamStatsPerRound
{
    ...
    /// <remarks>Change drivers: CD-10 (player-statistics/rank model: team kills)</remarks>
    public int Kills { get; private set; }

    /// <summary>Gets the team's deaths.</summary>
    /// <remarks>Change drivers: CD-10 (player-statistics/rank model: team deaths)</remarks>
    ...
    /// <remarks>Change drivers: CD-10 (player-statistics/rank model: round reset)</remarks>
    public void Reset()
    {
        Score = 0; 
        Kills = 0; 
