...
/// <remarks>Change drivers: CD-08 (account & authentication policy); CD-10 (player-statistics/rank model) → CD-08; CD-20 (outbound repository contract) → CD-08; CD-01 (open.mp/SampSharp platform API)</remarks>
    ...
    PlayerStatsRenderer playerStatsRenderer) : ISystem
{
    ...
    /// <remarks>Change drivers: CD-08 (account & authentication policy); CD-10 (player-statistics/rank model) → CD-08; CD-20 (outbound repository contract) → CD-08</remarks>
    [Event]
    ...
    /// <remarks>Change drivers: CD-08 (account & authentication policy); CD-10 (player-statistics/rank model) → CD-08</remarks>
