...
/// <remarks>Injected dependencies (change drivers of these elements): mapInfoService -> CD-29+CD-11; mapRotationService -> CD-29+CD-12. Each injection parameter is driven by the contract of its injected type + CD-21 (DI wiring).</remarks>
