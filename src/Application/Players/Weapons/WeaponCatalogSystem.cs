    ...
    WeaponCatalogSettings weaponCatalogSettings) : ISystem
{
    ...
    /// <remarks>Change drivers: CD-04 (root; weapon-catalog configuration); CD-03 (combat/weapon-rules specification) → CD-04; CD-07 (GunGame mode rules) → CD-04; CD-15 (command set) → CD-04; CD-32 (ECS runtime); CD-33 (dialog API); CD-36 (client-message API); CD-43 (command infrastructure) → CD-04</remarks>
