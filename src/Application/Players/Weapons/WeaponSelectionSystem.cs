...
/// <remarks>Change drivers: CD-07 (GunGame mode rules); CD-04 (weapon-catalog configuration); CD-03 (combat/weapon-rules specification); CD-01 (open.mp/SampSharp platform API)</remarks>
    ...
    ActiveWeaponCatalog weaponCatalog) : ISystem
{
    ...
    [PlayerCommand("p")]
    /// <remarks>Change drivers: CD-15 (command set); CD-03 (combat/weapon-rules specification); CD-01 (open.mp/SampSharp platform API)</remarks>
    ...
    /// <remarks>Change drivers: CD-07 (GunGame mode rules); CD-04 (weapon-catalog configuration); CD-15 (command set); CD-03 (combat/weapon-rules specification); CD-01 (open.mp/SampSharp platform API)</remarks>
