...
/// </summary>
/// <remarks>Change drivers: CD-10 (root; player-statistics/rank model); CD-17 (game configuration/.env schema) → CD-10; CD-20 (outbound repository contract) → CD-10; CD-15 (command set) → CD-10</remarks>
