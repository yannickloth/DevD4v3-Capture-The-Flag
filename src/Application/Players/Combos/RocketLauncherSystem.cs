...
/// <remarks>Change drivers: CD-05 (root; combo definitions); CD-17 (game configuration/.env schema) → CD-05; CD-12 (map-rotation rules) → CD-05; CD-01 (open.mp/SampSharp platform API) → CD-05</remarks>
