...
/// </summary>
/// <remarks>Change drivers: CD-02 (root; CTF game-rules specification); CD-11 (map configuration) → CD-02; CD-12 (map-rotation rules) → CD-02; CD-31 (player spawn/position/state/spectating) → CD-02</remarks>
