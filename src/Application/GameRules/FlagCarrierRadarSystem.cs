...
/// </summary>
/// <remarks>Change drivers: CD-02 (root; CTF game-rules specification: carrier radar rule); CD-38 (radar) → CD-02; CD-15 (command set: showrm/hiderm commands) → CD-02; CD-09 (authorization policy: moderator gating) → CD-02; CD-17 (game configuration/.env schema: FlagCarrier__ShowOnRadarMap) → CD-02</remarks>
    ...
    IWorldService worldService) : ISystem
{
    ...
    /// <remarks>Change drivers: CD-02 (root; CTF game-rules specification: carrier radar rule); CD-15 (command set: showrm command) → CD-02; CD-09 (authorization policy: moderator gating) → CD-02; CD-17 (game configuration/.env schema: FlagCarrier__ShowOnRadarMap) → CD-02; CD-38 (radar) → CD-02</remarks>
    ...
    /// <remarks>Change drivers: CD-02 (root; CTF game-rules specification: carrier radar rule); CD-15 (command set: hiderm command) → CD-02; CD-09 (authorization policy: moderator gating) → CD-02; CD-17 (game configuration/.env schema: FlagCarrier__ShowOnRadarMap) → CD-02; CD-38 (radar) → CD-02</remarks>
