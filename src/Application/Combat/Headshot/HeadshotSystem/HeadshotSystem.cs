namespace CTF.Application.Combat.Headshot.HeadshotSystem;

/// <summary>
/// Handles headshot detection, reward, and persistence.
/// </summary>
/// <remarks>Change drivers: CD-03 (root; combat/weapon-rules specification); CD-31 (player events); CD-32 (ECS runtime); CD-36 (client messages); CD-40 (audio API) → CD-03; CD-17 (game configuration/.env schema) → CD-03; CD-10 (player-statistics/rank model) → CD-03; CD-20 (outbound repository contract) → CD-03</remarks>
    ...
    HeadshotSettings headshotSettings) : ISystem
{
    ...
    /// </param>
    /// <remarks>Change drivers: CD-03 (root; combat/weapon-rules specification); CD-31 (OnPlayerTakeDamage); CD-36 (client messages); CD-40 (audio API) → CD-03; CD-17 (game configuration/.env schema) → CD-03; CD-10 (player-statistics/rank model) → CD-03; CD-20 (outbound repository contract) → CD-03</remarks>
    [Event]
