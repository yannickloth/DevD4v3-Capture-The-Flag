// <remarks>Change drivers: CD-01 (root; open.mp/SampSharp platform API); CD-23 (Serilog logging) → CD-01; CD-17 (game configuration/.env schema) → CD-01; CD-19 (MariaDB SQL dialect) → CD-01; CD-30 (SQLite SQL dialect) → CD-01; CD-20 (outbound repository contract) → CD-01</remarks>
