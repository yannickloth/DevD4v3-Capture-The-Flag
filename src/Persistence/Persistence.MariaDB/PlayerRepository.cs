...
/// <remarks>Change drivers: CD-20 (root; outbound repository contract); CD-18 (database schema/player data model) → CD-20; CD-19 (MariaDB SQL dialect) → CD-18; CD-25 (BCrypt password-hashing contract) → CD-20; CD-21 (DI container/composition) → CD-20</remarks>
