...
/// <remarks>Change drivers: CD-18 (database schema/player data model), CD-20 (outbound repository contract), CD-25 (BCrypt password-hashing contract)</remarks>
public class FakePlayer
{
    ...
    /// <remarks>Change drivers: CD-18 (database schema/player data model), CD-25 (BCrypt password-hashing contract), CD-21 (DI container/composition)</remarks>
