...
/// <remarks>Change drivers: CD-17 (game configuration/.env schema), CD-20 (outbound repository contract), CD-18 (database schema/player data model), CD-30 (SQLite SQL dialect)</remarks>
