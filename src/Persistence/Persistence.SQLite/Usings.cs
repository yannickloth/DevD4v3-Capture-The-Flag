// <remarks>Change drivers: CD-20 (outbound repository contract); CD-18 (database schema/player data model); CD-30 (SQLite SQL dialect) → CD-18; CD-21 (DI container/composition)</remarks>
